						...
						<div class="kt-subheader  kt-grid__item" id="kt_subheader">
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title">Control Structures Weight of the Program</h3>
        ...
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title kt-font-brand">
                    Control Structures Complexity of the Program
                </h3>
            </div>
            ...
            <div class="kt-form__actions">
                        ...
                        <div class="kt-portlet kt-portlet--mobile">
                            <div class="kt-portlet__head kt-portlet__head--lg">
                                <div class="kt-portlet__head-label">
                                    ...
                                    <h3 class="kt-portlet__head-title kt-font-brand">
                                         Complexity of the Program due to the Control Structures
                                    </h3>
                                </div>
                ...
                <div class="kt-portlet__foot">
                    ...
                    <div class="col-lg-12 ml-lg-auto">
                        <center>
                        <button type="submit" class="btn btn-success">Measure Weight from Control Structures</button>
