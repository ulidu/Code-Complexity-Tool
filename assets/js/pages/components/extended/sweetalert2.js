    ...
    var initDemos = function() {
        ...
        $('#kt_sweetalert_demo_82').click(function(e) {
            ...
            if ($a != 'index.php') {
                swal.fire({
                    title: 'Are you sure?',
                    html: "All the uploaded files and custom weights and custom weights will be removed.<br> Are you sure you want to continue ?",
                    type: 'warning',
                    showCancelButton: true,
                    confirmButtonText: 'Yes, Upload a New File'
                }).then(function(result) {
        ...
        $('#kt_sweetalert_demo_83').click(function(e) {
        ...
        $('#kt_sweetalert_demo_84').click(function(e) {
